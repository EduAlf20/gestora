...
namespace appgrpucpView {
	...
	/// <summary>
	/// Resumen de frmMeetings
	/// </summary>
	public ref class frmMeetings : public System::Windows::Forms::Form
	{
	public:
		frmMeetings(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(3) {
				this->Column1,
					this->Column2, this->Details
			});
			this->dataGridView1->Location = System::Drawing::Point(39, 36);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(941, 460);
			...
			this->Name = L"frmMeetings";
			this->Text = L"frmMeetings";
